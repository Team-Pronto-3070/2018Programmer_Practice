...
import org.usfirst.frc.team3070.robot.Auto.Auto_Path;

public interface Pronstants {
	final int PORT_RF = 2; // Right master CIM port
	final int PORT_RM = 5; // Right follower CIM port

	final int PORT_LF = 0; // Left master CIM port
	final int PORT_LM = 1; // Left follower CIM port
