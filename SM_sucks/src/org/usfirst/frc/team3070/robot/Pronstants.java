...
public interface Pronstants {
	public final int PORT_RM = 2; // Right master CIM port
	public final int PORT_RF = 5; // Right follower CIM port

	public final int PORT_LM = 0; // Left master CIM port
	public final int PORT_LF = 1; // Left follower CIM port
